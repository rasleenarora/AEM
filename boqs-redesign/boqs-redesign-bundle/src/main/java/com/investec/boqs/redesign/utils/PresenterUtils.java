...
import com.investec.boqs.redesign.presenter.AbstractPresenter;
...
public class PresenterUtils {
     ...
     * @param clazz Class<? extends AbstractPresenter>
     * @param request SlingHttpServletRequest
     * @param properties ValueMap
     ...
     * @throws RepositoryException
     */
    public static void makePresenter(Class<? extends AbstractPresenter> clazz, SlingHttpServletRequest request, ValueMap properties, Node currentNode, Style currentStyle) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, RepositoryException {
        AbstractPresenter abstractPresenter = clazz.getConstructor().newInstance();
        abstractPresenter.init(request, properties, currentNode, currentStyle);
    }
}
