...
ExperienceAEM.MultiFieldPanel = CQ.Ext.extend(CQ.Ext.Panel, {
    ...
    afterRender : function(){
        ...
        this.items.each(function(){
            if(this.xtype == "selection"){
                if(this.hasOwnProperty("optionsKey") && this.optionsKey){
                    var json=loadCategories(this.optionsKey);    
...
CQ.Ext.reg("multifieldpanel", ExperienceAEM.MultiFieldPanel);