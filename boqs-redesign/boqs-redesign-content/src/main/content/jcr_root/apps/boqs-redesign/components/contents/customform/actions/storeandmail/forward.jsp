...
<%@page import="org.apache.sling.api.resource.ResourceUtil,
	...
	//set empty array to prevent null pointer exception
	String[] empty = {};
    ...
    if (StringUtils.isNotBlank(queryString)){
		curPath += queryString + "&" + BOQSConstant.PARAM_RESULT_SENDMAIL + "=" + result + "&" + BOQSConstant.TYPE + "=" + BOQSConstant.TYPE_CONTACT;
	} else{
		curPath += "?" + BOQSConstant.PARAM_RESULT_SENDMAIL + "=" + result + "&" + BOQSConstant.TYPE + "=" + BOQSConstant.TYPE_CONTACT;
